...
class VmRepository
{
    ...
    {
        $db = $this->db();
        $stmt = $db->prepare('INSERT INTO vms (name, template_id, cpu, cpu_sockets, cpu_cores, cpu_threads, memory_mb, disk_path, disk_size_gb, disks_json, network_name, ip_pool_id, status, ip_address, xml_path, cloud_init_iso_path, cloud_init_user_override, cloud_init_password_override, cloud_init_ssh_key_override, cloud_init_hostname_override, cloud_init_dns_override, cloud_init_search_domain_override, cloud_init_extra_user_data_override, vnc_display, expires_at, expire_action, expire_grace_days, expired_at, nics_json, created_at) VALUES (:name, :template_id, :cpu, :cpu_sockets, :cpu_cores, :cpu_threads, :memory_mb, :disk_path, :disk_size_gb, :disks_json, :network_name, :ip_pool_id, :status, :ip_address, :xml_path, :cloud_init_iso_path, :cloud_init_user_override, :cloud_init_password_override, :cloud_init_ssh_key_override, :cloud_init_hostname_override, :cloud_init_dns_override, :cloud_init_search_domain_override, :cloud_init_extra_user_data_override, :vnc_display, :expires_at, :expire_action, :expire_grace_days, :expired_at, :nics_json, :created_at)');
        $stmt->execute($data);
