...
class SchemaService
{
    ...
    public function ensure(): void
    {
        ...
        $queries = [
            ...
            "CREATE TABLE IF NOT EXISTS node_network_resources (id {$idColumn}, name VARCHAR(191) NOT NULL UNIQUE, type VARCHAR(32) NOT NULL DEFAULT 'bridge', parent VARCHAR(64) DEFAULT NULL, ports_json TEXT DEFAULT NULL, vlan_id INTEGER DEFAULT NULL, bond_mode VARCHAR(64) DEFAULT NULL, bridge_vlan_aware {$boolType} NOT NULL DEFAULT 0, cidr VARCHAR(128) DEFAULT NULL, gateway VARCHAR(128) DEFAULT NULL, ipv6_cidr VARCHAR(128) DEFAULT NULL, ipv6_gateway VARCHAR(128) DEFAULT NULL, mtu INTEGER DEFAULT NULL, autostart {$boolType} NOT NULL DEFAULT 0, comments TEXT DEFAULT NULL, managed_on_host {$boolType} NOT NULL DEFAULT 0, last_apply_status VARCHAR(64) DEFAULT 'draft', last_apply_output TEXT DEFAULT NULL, created_at TEXT NOT NULL, updated_at TEXT DEFAULT NULL)",
            "CREATE TABLE IF NOT EXISTS templates (id {$idColumn}, name VARCHAR(191) NOT NULL UNIQUE, vmid_hint INTEGER DEFAULT NULL, image_id BIGINT NOT NULL, image_type VARCHAR(32) NOT NULL, os_type VARCHAR(32) DEFAULT 'l26', os_source VARCHAR(32) DEFAULT 'image', os_variant VARCHAR(191) NOT NULL, cpu INTEGER NOT NULL DEFAULT 1, cpu_type VARCHAR(64) DEFAULT 'host', cpu_numa {$boolType} NOT NULL DEFAULT 0, cpu_limit_percent INTEGER DEFAULT NULL, cpu_units INTEGER DEFAULT NULL, memory_mb INTEGER NOT NULL DEFAULT 512, memory_min_mb INTEGER DEFAULT NULL, memory_max_mb INTEGER DEFAULT NULL, balloon_enabled {$boolType} NOT NULL DEFAULT 1, disk_size_gb INTEGER NOT NULL DEFAULT 10, disk_bus VARCHAR(50) NOT NULL DEFAULT 'virtio', scsi_controller VARCHAR(64) DEFAULT 'virtio-scsi-single', disk_overcommit_enabled {$boolType} NOT NULL DEFAULT 0, network_name VARCHAR(191) NOT NULL DEFAULT 'default', notes TEXT DEFAULT '', cloud_init_enabled {$boolType} NOT NULL DEFAULT 0, cloud_init_user VARCHAR(191) DEFAULT NULL, cloud_init_password VARCHAR(191) DEFAULT NULL, cloud_init_ssh_key TEXT DEFAULT NULL, cloud_init_hostname VARCHAR(191) DEFAULT NULL, cloud_init_dns_servers TEXT DEFAULT NULL, cloud_init_search_domain VARCHAR(191) DEFAULT NULL, cloud_init_extra_user_data TEXT DEFAULT NULL, virtualization_mode VARCHAR(32) DEFAULT 'kvm', cpu_sockets INTEGER DEFAULT 1, cpu_cores INTEGER DEFAULT 1, cpu_threads INTEGER DEFAULT 1, machine_type VARCHAR(64) DEFAULT 'pc', firmware_type VARCHAR(32) DEFAULT 'bios', qemu_agent_enabled {$boolType} NOT NULL DEFAULT 1, display_type VARCHAR(32) DEFAULT 'vnc', serial_console_enabled {$boolType} NOT NULL DEFAULT 1, gpu_type VARCHAR(64) DEFAULT 'cirrus', autostart_default {$boolType} NOT NULL DEFAULT 0, memory_overcommit_percent INTEGER DEFAULT 100, disks_json TEXT DEFAULT NULL, nics_json TEXT DEFAULT NULL, created_at TEXT NOT NULL)",
            "CREATE TABLE IF NOT EXISTS vms (id {$idColumn}, name VARCHAR(191) NOT NULL UNIQUE, template_id BIGINT NOT NULL, cpu INTEGER NOT NULL, cpu_sockets INTEGER DEFAULT 1, cpu_cores INTEGER DEFAULT 1, cpu_threads INTEGER DEFAULT 1, memory_mb INTEGER NOT NULL, disk_path TEXT NOT NULL, disk_size_gb INTEGER NOT NULL, disks_json TEXT DEFAULT NULL, network_name VARCHAR(191) NOT NULL DEFAULT 'default', ip_pool_id BIGINT DEFAULT NULL, status VARCHAR(50) NOT NULL, ip_address VARCHAR(191) DEFAULT NULL, xml_path TEXT NOT NULL, cloud_init_iso_path TEXT DEFAULT NULL, cloud_init_user_override VARCHAR(191) DEFAULT NULL, cloud_init_password_override VARCHAR(191) DEFAULT NULL, cloud_init_ssh_key_override TEXT DEFAULT NULL, cloud_init_hostname_override VARCHAR(191) DEFAULT NULL, cloud_init_dns_override TEXT DEFAULT NULL, cloud_init_search_domain_override VARCHAR(191) DEFAULT NULL, cloud_init_extra_user_data_override TEXT DEFAULT NULL, vnc_display VARCHAR(191) DEFAULT NULL, expires_at TEXT DEFAULT NULL, expire_action VARCHAR(32) DEFAULT 'pause', expire_grace_days INTEGER DEFAULT 3, expired_at TEXT DEFAULT NULL, nics_json TEXT DEFAULT NULL, created_at TEXT NOT NULL, updated_at TEXT DEFAULT NULL)",
        ...
        $ensureColumns = [
            ...
            ['node_network_resources', 'type', "VARCHAR(32) NOT NULL DEFAULT 'bridge'"],
            ['node_network_resources', 'parent', 'VARCHAR(64) DEFAULT NULL'],
            ['node_network_resources', 'ports_json', 'TEXT DEFAULT NULL'],
            ['node_network_resources', 'vlan_id', 'INTEGER DEFAULT NULL'],
            ['node_network_resources', 'bond_mode', 'VARCHAR(64) DEFAULT NULL'],
            ['node_network_resources', 'bridge_vlan_aware', $boolType . ' NOT NULL DEFAULT 0'],
            ['node_network_resources', 'cidr', 'VARCHAR(128) DEFAULT NULL'],
            ['node_network_resources', 'gateway', 'VARCHAR(128) DEFAULT NULL'],
            ['node_network_resources', 'ipv6_cidr', 'VARCHAR(128) DEFAULT NULL'],
            ['node_network_resources', 'ipv6_gateway', 'VARCHAR(128) DEFAULT NULL'],
            ['node_network_resources', 'mtu', 'INTEGER DEFAULT NULL'],
            ['node_network_resources', 'autostart', $boolType . ' NOT NULL DEFAULT 0'],
            ['node_network_resources', 'comments', 'TEXT DEFAULT NULL'],
            ['node_network_resources', 'managed_on_host', $boolType . ' NOT NULL DEFAULT 0'],
            ['node_network_resources', 'last_apply_status', "VARCHAR(64) DEFAULT 'draft'"],
            ['node_network_resources', 'last_apply_output', 'TEXT DEFAULT NULL'],
            ['node_network_resources', 'updated_at', 'TEXT DEFAULT NULL'],
            ['templates', 'vmid_hint', 'INTEGER DEFAULT NULL'],
            ['templates', 'os_type', "VARCHAR(32) DEFAULT 'l26'"],
            ['templates', 'os_source', "VARCHAR(32) DEFAULT 'image'"],
            ['templates', 'virtualization_mode', "VARCHAR(32) DEFAULT 'kvm'"],
            ['templates', 'cpu_type', "VARCHAR(64) DEFAULT 'host'"],
            ['templates', 'cpu_numa', $boolType . ' NOT NULL DEFAULT 0'],
            ['templates', 'cpu_limit_percent', 'INTEGER DEFAULT NULL'],
            ['templates', 'cpu_units', 'INTEGER DEFAULT NULL'],
            ...
            ['templates', 'scsi_controller', "VARCHAR(64) DEFAULT 'virtio-scsi-single'"],
            ['templates', 'qemu_agent_enabled', $boolType . ' NOT NULL DEFAULT 1'],
            ['templates', 'display_type', "VARCHAR(32) DEFAULT 'vnc'"],
            ['templates', 'serial_console_enabled', $boolType . ' NOT NULL DEFAULT 1'],
            ['templates', 'gpu_type', "VARCHAR(64) DEFAULT 'cirrus'"],
            ['templates', 'autostart_default', $boolType . ' NOT NULL DEFAULT 0'],
            ['templates', 'memory_min_mb', 'INTEGER DEFAULT NULL'],
            ['templates', 'memory_max_mb', 'INTEGER DEFAULT NULL'],
            ['templates', 'balloon_enabled', $boolType . ' NOT NULL DEFAULT 1'],
            ['templates', 'memory_overcommit_percent', 'INTEGER DEFAULT 100'],
            ['templates', 'disk_overcommit_enabled', $boolType . ' NOT NULL DEFAULT 0'],
            ['templates', 'cloud_init_hostname', 'VARCHAR(191) DEFAULT NULL'],
            ['templates', 'cloud_init_dns_servers', 'TEXT DEFAULT NULL'],
            ['templates', 'cloud_init_search_domain', 'VARCHAR(191) DEFAULT NULL'],
            ['templates', 'cloud_init_extra_user_data', 'TEXT DEFAULT NULL'],
            ...
            ['vms', 'cloud_init_user_override', 'VARCHAR(191) DEFAULT NULL'],
            ['vms', 'cloud_init_password_override', 'VARCHAR(191) DEFAULT NULL'],
            ['vms', 'cloud_init_ssh_key_override', 'TEXT DEFAULT NULL'],
            ['vms', 'cloud_init_hostname_override', 'VARCHAR(191) DEFAULT NULL'],
            ['vms', 'cloud_init_dns_override', 'TEXT DEFAULT NULL'],
            ['vms', 'cloud_init_search_domain_override', 'VARCHAR(191) DEFAULT NULL'],
            ['vms', 'cloud_init_extra_user_data_override', 'TEXT DEFAULT NULL'],
